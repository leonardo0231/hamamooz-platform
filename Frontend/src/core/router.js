...
export const routes = [
  ...
  { id: 'reports', pattern: /^\/reports\/?$/, title: 'گزارش‌ها', roles: ['system_admin', 'organization_admin', 'school_manager', 'educational_deputy', 'operator', 'teacher'] },
  ...
  { id: 'settings', pattern: /^\/settings\/?$/, title: 'تنظیمات', roles: ['system_admin', 'organization_admin', 'school_manager', 'educational_deputy'] },
