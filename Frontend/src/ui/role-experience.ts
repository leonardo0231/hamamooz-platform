...
const experiences: Record<Role, RoleExperience> = {
  ...
  student_affairs_deputy: {
    ...
    primaryAction: { label: 'وقایع رفتاری', href: '/resources/behavior-events', icon: 'warning' },
    secondaryAction: { label: 'فعالیت‌ها', href: '/resources/activities', icon: 'sparkles' },
  ...
  counselor: {
    ...
    primaryAction: { label: 'پرونده‌های مشاوره', href: '/resources/counseling-cases', icon: 'lock' },
  ...
  guide_teacher: {
    ...
    primaryAction: { label: 'تخصیص‌های راهنمایی', href: '/resources/guide-teacher-assignments', icon: 'users' },
    secondaryAction: { label: 'پیگیری‌ها', href: '/resources/guide-follow-ups', icon: 'check' },
