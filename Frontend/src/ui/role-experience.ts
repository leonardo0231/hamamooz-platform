...
const experiences: Record<Role, RoleExperience> = {
  system_admin: {
    ...
    primaryAction: { label: 'مدیریت سامانه', href: '/administration', icon: 'settings' },
    secondaryAction: { label: 'مرکز داده', href: '/data-center', icon: 'upload' },
  ...
  school_manager: {
    ...
    primaryAction: { label: 'موارد نیازمند پیگیری', href: '/follow-up?view=operational-alerts', icon: 'bell' },
  ...
  educational_deputy: {
    ...
    primaryAction: { label: 'مدیریت ارزیابی‌ها', href: '/education?view=assessments', icon: 'chart' },
    secondaryAction: { label: 'ارزیابی جامع ماهانه', href: '/education?view=monthly-evaluations', icon: 'edit' },
  ...
  operator: {
    ...
    primaryAction: { label: 'مرکز داده', href: '/data-center', icon: 'upload' },
    secondaryAction: { label: 'اصلاح پیشرفته داده', href: '/manual-entry', icon: 'edit' },
  ...
  teacher: {
    ...
    primaryAction: { label: 'ثبت و مدیریت ارزیابی', href: '/education?view=assessments', icon: 'chart' },
  ...
  student_affairs_deputy: {
    ...
    title: name => `پیگیری دانش‌آموزان، ${name}`,
    description: 'وقایع رفتاری، فعالیت‌ها و هشدارهای عملیاتی در محدوده مدرسه مجاز.',
    primaryAction: { label: 'رشد و پیگیری', href: '/follow-up?view=behavior', icon: 'warning' },
    secondaryAction: { label: 'موارد نیازمند پیگیری', href: '/follow-up?view=operational-alerts', icon: 'sparkles' },
    sectionOrder: ['attention', 'metrics', 'alerts', 'activity', 'evaluation', 'classes', 'workflow', 'schools'],
    metricOrder: ['students', 'missing_scores', 'classes', 'teachers'],
    evaluationTitle: 'وضعیت پیگیری دانش‌آموزان',
    evaluationDescription: 'برای این نقش، endpoint اختصاصی داشبورد تنها شاخص‌های دامنه مجاز را بازمی‌گرداند.',
  },
  counselor: {
    role: 'counselor',
    eyebrow: 'مشاوره محرمانه',
    title: name => `پرونده‌های منتسب به شما، ${name}`,
    description: 'یادداشت‌های خصوصی فقط از مرز محرمانه مشاوره و برای مشاورِ مالک خوانده می‌شوند.',
    primaryAction: { label: 'پرونده‌های مشاوره', href: '/follow-up?view=counseling-cases', icon: 'lock' },
    sectionOrder: ['metrics'],
    metricOrder: ['students', 'classes', 'teachers', 'missing_scores'],
    evaluationTitle: 'نمایش داده محرمانه',
    evaluationDescription: 'داشبورد اختصاصی مشاور به‌جای dashboard عمومی، شمارش امن پرونده‌های منتسب را نمایش می‌دهد.',
  },
  guide_teacher: {
    role: 'guide_teacher',
    eyebrow: 'معلم راهنما',
    title: name => `پیگیری cohort شما، ${name}`,
    description: 'تنها تخصیص‌ها و برنامه‌های پیگیری دانش‌آموزان منتسب به شما قابل مشاهده است.',
    primaryAction: { label: 'تخصیص‌های راهنمایی', href: '/follow-up?view=guide-assignments', icon: 'users' },
    secondaryAction: { label: 'پیگیری‌ها', href: '/follow-up?view=guide-follow-ups', icon: 'check' },
    sectionOrder: ['metrics', 'activity'],
    metricOrder: ['students', 'classes', 'teachers', 'missing_scores'],
    evaluationTitle: 'پیگیری دانش‌آموزان منتسب',
    evaluationDescription: 'داشبورد اختصاصی معلم راهنما محدودیت cohort را در Backend اعمال می‌کند.',
  },
};
