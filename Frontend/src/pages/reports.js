...
const REPORT_PAGE_SIZE = 'a3_landscape';
const pageSizeLabel = () => 'A3 افقی · قالب ثابت چاپی';
...
export function ReportsPage() {
  ...
  return html`<div class="page report-workspace">
    ...
    <section class="report-preview-zone" data-report-print-root>
      <header class="report-preview-zone__header"><div><span>پیش‌نمایش تعاملی React</span><h2>${previewSnapshot ? 'کارنامهٔ انتخاب‌شده' : 'نمونهٔ کارنامهٔ قابل ارائه'}</h2><p>${previewSnapshot ? 'این نمایش از snapshot نهاییِ آرشیوشده ساخته شده است.' : 'همین خروجی A3 افقی را از مرورگر چاپ یا به PDF ذخیره کنید.'}</p></div><div class="report-preview-zone__actions"><div class="report-preview-zone__legend"><i></i>نمودارها و تحلیل‌ها در همین درخت DOM ساخته می‌شوند</div><button class="button button--outline report-print-button" type="button" disabled=${previewLoading} onClick=${printAnalyticalReport}>چاپ / ذخیرهٔ PDF</button></div></header>
