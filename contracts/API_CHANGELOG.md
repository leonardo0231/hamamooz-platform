...
- `GET /api/v1/subject-exam-results/` برای بازبینی محدودشدهٔ ردیف‌های خام سه کارنامهٔ آزمون تابستانه
...
- ورود مستقیم پوشهٔ `Data` ابتدا ۱۲ فایل جامع را به جداول دانش‌آموز/کلاس/ثبت‌نام/ارزیابی و سپس سه فایل آزمون درسی را به collection مستقل وارد می‌کند؛ دادهٔ خام و فرمول‌ها برای ممیزی حفظ می‌شوند.
