...
def test_visuals_are_derived_only_from_snapshot_data():
    report = {
        ...
        "subjects": [
            {"title": "ریاضی", "average": "19.00", "continuous": "19", "final": "19", "passed": True},
            {"title": "عربی", "average": "14.00", "continuous": "14", "final": "14", "passed": True},
        ],
        "product_context": {
            "attendance": {"attendance_rate": 96, "finalized_session_count": 40, "unexcused_absence_count": 1},
            "evaluations": [{"metrics": [
                {"code": "EDU_05", "title": "دقت و تمرکز", "value": 4},
                {"code": "DEV_02", "title": "مسئولیت‌پذیری", "value": 5},
                {"code": "PER_01", "title": "مدیریت زمان", "value": 4},
            ]}],
            "activities": [{"title": "پژوهش", "kind": "research", "result": "برگزیده"}],
        },
    }
