"""Render the 3:2 analytical template used by the MVP report workflow.
        ...
        "reports": [
            {
                ...
                "school": {
                    "name": "دبیرستان پسرانه دورهٔ اول آینده",
                    "branch": "شعبه مرکزی",
                    "address": "تهران، منطقهٔ آموزشی نمونه",
                    "phone": "۰۲۱-۸۸۸۸۸۸۸۸",
                    "manager": "مدیر مدرسه",
                    "logo_url": "",
                },
                    ...
                    "evaluations": [
                        {
                            ...
                            "metrics": [
                                {"code": "EDU_01", "title": "نمرات درسی", "value": 5},
                                {"code": "EDU_02", "title": "پیشرفت نسبت به قبل", "value": 4},
                                {"code": "EDU_05", "title": "دقت و تمرکز", "value": 4},
                                {"code": "DEV_01", "title": "احترام و همکاری", "value": 5},
                                {"code": "DEV_02", "title": "مسئولیت‌پذیری", "value": 5},
                                {"code": "DEV_04", "title": "نظم شخصی", "value": 4},
                                {"code": "CHR_02", "title": "انگیزه برای یادگیری", "value": 4},
                                {"code": "CHR_03", "title": "پشتکار", "value": 4},
                                {"code": "PER_01", "title": "مدیریت زمان", "value": 4},
                                {"code": "PER_02", "title": "مهارت ارتباطی", "value": 4},
                            ],
                        }
                    ],
                    ...
                    "activities": [
                        {
                            "title": "المپیاد علمی",
                            "kind": "competition",
                            "result": "مقام دوم منطقه",
                            "placement": 2,
                        },
                        {
                            "title": "مسابقات ورزشی",
                            "kind": "sport",
                            "result": "عضو تیم مدرسه",
                            "placement": None,
                        },
                        {
                            "title": "پژوهش و تحلیل",
                            "kind": "research",
                            "result": "پروژه برگزیده",
                            "placement": 1,
                        },
                        {
                            "title": "باشگاه کتاب‌خوانی",
                            "kind": "cultural",
                            "result": "مشارکت مستمر",
                            "placement": None,
                        },
...
def main() -> None:
    output = WORKSPACE_ROOT / "output" / "pdf" / "hamamooz-analytical-report-mvp-3x2.pdf"
