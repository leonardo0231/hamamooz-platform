...
IMPORT_MAX_SMART_ROWS = int(os.getenv("IMPORT_MAX_SMART_ROWS", "5000"))
IMPORT_MAX_SMART_COLUMNS = int(os.getenv("IMPORT_MAX_SMART_COLUMNS", "100"))
IMPORT_MAX_EXPANDED_ROWS = int(os.getenv("IMPORT_MAX_EXPANDED_ROWS", "100000"))
IMPORT_MAX_UNCOMPRESSED_BYTES = int(
    os.getenv("IMPORT_MAX_UNCOMPRESSED_BYTES", str(50 * 1024 * 1024))
)
EVALUATION_FINAL_COMPLETION_PERCENT = int(os.getenv("EVALUATION_FINAL_COMPLETION_PERCENT", "100"))
EVALUATION_TREND_EPSILON = float(os.getenv("EVALUATION_TREND_EPSILON", "0.5"))
